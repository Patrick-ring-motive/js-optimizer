(function(global, factory) {
    ...
    BertTokenizer.prototype.loadVocab = function() {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2 /*return*/ , tf.util.fetch(VOCAB_URL).then(function(d) {
            return d.json();
          })];
        });
      });
  ...
  const NO_ANSWER_THRESHOLD = -1; //4.3980759382247925;
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_c) {
          switch (_c.label) {
            case 0:
              _a = this;
              return [4 /*yield*/ , tfconv.loadGraphModel(this.modelConfig.modelUrl, {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [2 /*return*/ , answers.reduce(function(flatten, array) {
